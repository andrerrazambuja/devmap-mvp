...
>
  ...
  <!-- Roadmaps List -->
  <div
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full px-4 md:px-16 justify-items-center align-items-center"
  >
